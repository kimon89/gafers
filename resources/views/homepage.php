...
{{#each featured}}
	<div class="row post">
		...
		<div class="row">
			<div class="col-md-12">
				{{#if ../isMobile}}
				<video {{#if last}} data-last="true" {{/if}} width="100%" autobuffer loop controls poster="https://thumbs.gfycat.com/{{file_name}}-thumb360.jpg">
						<source src="{{webm}}" type="video/webm">
						<source src="{{mp4}}" type="video/mp4">
					</video>
				{{else}}
				<a href="/gaf/{{url_key}}">
					<video {{#if last}} data-last="true" {{/if}} width="100%" autobuffer loop>
						<source src="{{webm}}" type="video/webm">
						<source src="{{mp4}}" type="video/mp4">
					</video>
				</a>
